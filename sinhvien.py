class SinhVienPoly:
    ...
    #Xuất 
    def xuat_tt(self):
        print(f"{self.ten_sinh_vien:<20} {self.nganh_hoc:<10} {self.get_diem():<8} {self.get_hoc_luc():10}")
    def __str__(self):
        return f"{self.ten_sinh_vien:<20} | {self.nganh_hoc:<10} | {self.get_diem():<8} | {self.get_hoc_luc():10}"
